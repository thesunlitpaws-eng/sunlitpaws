...
const i18nServer = {
  en: {
    ...
    'news.sub': 'Latest trends, insights, and company updates',
    ...
    'footer.copy': '© 2025 Sunlitpaws Co., Ltd. All Rights Reserved.',
    ...
    'prod.filter.all': 'All',
    'prod.filter.food': 'Pet Food',
    'prod.filter.toys': 'Pet Toys',
    'prod.filter.supplies': 'Pet Supplies',
    'prod.sup.bed': 'Pet Beds',
    'prod.sup.catTree': 'Cat Trees',
    'prod.sup.carrier': 'Pet Carriers',
    'prod.sup.stroller': 'Pet Strollers',
    'prod.sup.carSeat': 'Pet Car Seats',
    'prod.sup.litter': 'Litter Boxes',
    ...
    'sol.c1.l4': 'Flexible MOQ from 200 units',
    ...
    'sol.c2.l4': 'Competitive wholesale pricing',
    ...
    'sol.c3.l4': 'Net 30/60 payment terms',
    'faq.tab.all': 'All',
    'faq.tab.factory': 'Factory & Credentials',
    'faq.tab.product': 'Products & Customization',
    'faq.tab.quality': 'Quality Control',
    'faq.tab.production': 'Production & Logistics',
    'faq.tab.business': 'Business & Cooperation',
    'faq.tab.export': 'Export & Certification',
    'faq.tab.process': 'Cooperation & Contact',
    'tab.all': 'All',
  ...
  zh: {
    ...
    // Footer
    'footer.desc': '专业宠物用品制造商和出口商，自2014年起以品质、可靠和创新服务全球采购商。',
    'footer.products': '产品',
    'footer.food': '宠物食品',
    'footer.toys': '宠物玩具',
    ...
    'footer.contact': '联系方式',
    'footer.inquiry': '发送询盘',
    'footer.copy': '© 2025 河北顺立科技有限公司 版权所有',
    'footer.icp': '冀ICP备XXXXXXXX号',
    ...
    'form.submit': '发送询盘',
    'form.note': '🔒 您的信息安全保密，我们24小时内回复。',
    
    // Modal
    'modal.title': '发送询盘',
    'modal.sub': '我们将在24小时内回复您',
    
    // Toast
    'toast.title': '询盘已发送！',
    'toast.msg': '我们将在24小时内回复您。',
    ...
    // Products
    'prod.tag': '产品中心',
    'prod.title': '一站式宠物用品采购',
    'prod.sub': '从营养到生活方式 — 满足您客户对爱宠的一切需求',
    'prod.filter.all': '全部',
    'prod.filter.food': '宠物食品',
    'prod.filter.toys': '宠物玩具',
    'prod.filter.supplies': '宠物用品',
    'prod.sup.bed': '宠物窝',
    'prod.sup.catTree': '猫爬架',
    'prod.sup.carrier': '宠物包',
    'prod.sup.stroller': '宠物推车',
    'prod.sup.carSeat': '宠物汽车座椅',
    'prod.sup.litter': '猫砂盆',
    'faq.learnMore': '了解更多 →',
    'news.related': '更多新闻',
    'news.back': '← 返回新闻',
    ...
    'case.tag': '成功案例',
    'case.title': '全球200+合作伙伴信赖之选',
    'case.sub': '真实合作，真实成果——了解我们如何帮助品牌在全球成长',
    'case.cta': '成为下一个成功案例',
    'sol.c1.title': '品牌OEM/ODM解决方案',
    'sol.c1.desc': '为寻求可靠制造合作伙伴的宠物品牌提供从产品开发、生产到质量控制和包装的全链条服务——您专注于品牌与市场。',
    'sol.c1.l1': '定制配方与设计',
    'sol.c1.l2': '品牌定制包装',
    'sol.c1.l3': '合规性支持',
    'sol.c1.l4': 'MOQ灵活，起订200件',
    'sol.c2.title': '电商供应链解决方案',
    'sol.c2.desc': '为亚马逊、Shopify及跨境电商卖家提供快速生产周期、竞争性价格和FBA-ready包装，助力您的listing保持竞争力。',
    'sol.c2.l1': 'FBA-ready包装与标签',
    'sol.c2.l2': '快速30-45天交期',
    'sol.c2.l3': '小批量试单',
    'sol.c2.l4': '竞争性批发价格',
    'sol.c3.title': '零售批发方案',
    'sol.c3.desc': '为宠物连锁店和经销商提供始终如一的品质、可靠的交货计划和全面的产品线，确保您的货架常年有货。',
    'sol.c3.l1': '全产品线采购',
    'sol.c3.l2': '季节性系列规划',
    'sol.c3.l3': '专属客户经理',
    'sol.c3.l4': '账期30/60天',
    'faq.tab.all': '全部',
    'faq.tab.factory': '🏭 工厂实力',
    'faq.tab.product': '📦 产品定制',
    'faq.tab.quality': '🔧 质量控制',
    'faq.tab.production': '🚛 生产物流',
    'faq.tab.business': '💰 商务合作',
    'faq.tab.export': '🌍 出口认证',
    'faq.tab.process': '🤝 合作流程',
    'tab.all': '全部',
...
app.get('/resources/faq/', (req, res) => {
  const lang = req.query.lang || req.cookies?.lang || 'en';
  res.render('faq.ejs', { lang, faqs, _ssr: true, t: (key) => t(key, lang) });
});
...
app.get('/api/site/news', (req, res) => {
  ...
  const result = news.map(n => {
    if (lang === 'en') {
      ...
      return { ...n, title: (n.title_en && n.title_en !== n.title) ? n.title_en : 'Sunlitpaws News', excerpt: (n.excerpt_en && n.excerpt_en !== n.excerpt) ? n.excerpt_en : 'Stay updated with the latest industry trends and company news', content: n.content_en || n.content_zh || n.content };
    }
    return n;
  });
  res.json(result);
